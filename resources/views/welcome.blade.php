            ...
            <nav class="navbar navbar-expand-lg">
                <div class="container">
                    <a class="navbar-brand" href="#">
                        <img src="{{ asset('landpage/assets/logo2.png') }}" alt="khatarsis" width="215"
                            height="50" />
                    </a>
                ...
                <div class="card" style="border-radius: 1rem">
                    <div class="row g-0">
                        <div class="col-md-6 col-lg-5 d-none d-md-block">
                            <img src="{{ asset('landpage/assets/image/ww.jpg') }}" alt="login form" class="img-fluid"
                            ...
                            <div class="card-body p-4 p-lg-5 text-black">
                                <form>
                                    <div class="d-flex align-items-center mb-3 pb-1">
                                        <img src="{{ asset('landpage/assets/logo2.png') }}" class="rounded img-fluid"
                                            alt="..." />
                                    </div>
                                </form>
                            </div>
